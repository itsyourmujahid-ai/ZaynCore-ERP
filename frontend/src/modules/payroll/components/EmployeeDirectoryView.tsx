                    ...
                    <tr key={emp.id} className="hover:bg-slate-800/30 transition-colors">
                      ...
                      <td className="p-3">
                        {emp.hasSystemAccess || emp.systemUserId ? (
                          ...
                          <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-slate-800/80 text-slate-400 border border-slate-700/50">
                      ...
                      <td className="p-3 text-slate-400">{emp.joiningDate}</td>
            ...
            <form onSubmit={handleSaveEmployee} className="p-6 overflow-y-auto space-y-5 text-xs">
              ...
              <div className="space-y-3 border-t border-slate-800 pt-4">
                ...
                {isQuickAddDesgOpen && (
                  <div className="p-3.5 rounded-xl bg-cyan-950/30 border border-cyan-800/50 space-y-2.5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div>
                        <label className="block text-[11px] text-slate-400 mb-0.5">Designation Title</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-[11px] text-slate-400 mb-0.5">Code (Optional)</label>
                        <input
                          type="text"
                          placeholder="e.g. DESG-DEV-01"
                          value={quickDesgCode}
                          onChange={(e) => setQuickDesgCode(e.target.value)}
                          className="w-full px-2.5 py-1.5 bg-slate-900 border border-slate-700 rounded-lg text-slate-200 text-xs uppercase"
                        />
                      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-slate-400 mb-1">Designation (Cascaded)</label>
                    <select
                  ...
                  <div>
                    <label className="block text-slate-400 mb-1">Job Title / Display Role *</label>
                    <input
                      type="text"
                      required
              ...
              <div className="border-t border-slate-800 pt-4 space-y-3">
                ...
                {formEnableSystemAccess && (
                  <div className="p-4 rounded-xl bg-indigo-950/20 border border-indigo-800/40 space-y-3 animate-fadeIn">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div>
                        <label className="block text-slate-400 mb-1">Username {!editingEmployee && '*'}</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-slate-400 mb-1">System Security Role *</label>
                        <select
                          value={formRoleId}
              ...
              <div className="space-y-3 border-t border-slate-800 pt-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-slate-400 mb-1">Basic Monthly Wage ($) *</label>
                    <input
                      type="number"
                      step="0.01"
                      required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-slate-400 mb-1">Bank IBAN / Account Number</label>
                    <input
                      type="text"
                      value={formBankIban}
