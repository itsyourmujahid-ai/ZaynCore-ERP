...
export const DashboardView: React.FC<{ onNavigate: (viewId: string) => void }> = ({ onNavigate }) => {
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-8">
      ...
      {/* 1. TOP ROW: 6 Distinct Frosted KPI Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        {/* Card 1: KPI #2.33 */}
        <div className="p-4 rounded-xl bg-card border border-border shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
          ...
          <div className="text-[11px] text-muted-foreground mt-1 flex items-center justify-between border-t border-border pt-1.5">
            <span>Active Velocity</span>
            <span className="font-mono text-foreground font-bold">#0F1725</span>
          </div>
        </div>
        ...
        {/* Card 3: Option 2 #0F1725 */}
        <div className="p-4 rounded-xl bg-card border border-border shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
          <div className="flex items-center justify-between text-xs font-semibold text-muted-foreground mb-1.5">
            <span>Option 2</span>
            <span className="font-mono text-[10px] text-muted-foreground font-bold">#0F1725</span>
          </div>
          <div className="text-2xl font-black text-foreground tracking-tight my-1">
            {journals.length + accounts.length * 2}
          </div>
          <div className="text-[11px] text-muted-foreground mt-1 truncate border-t border-border pt-1.5">
            Automated GL Rules
          </div>
        </div>

        {/* Card 4: Success #DCFCE7 */}
        <div className="p-4 rounded-xl bg-card border border-emerald-500/30 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
          <div className="flex items-center justify-between text-xs font-semibold text-emerald-700 dark:text-emerald-400 mb-1.5">
            ...
            <span className="font-mono text-[10px] text-emerald-700 dark:text-emerald-300 font-bold bg-emerald-500/10 px-1 py-0.5 rounded border border-emerald-500/20">#DCFCE7</span>
          </div>
          <div className="text-2xl font-black text-foreground tracking-tight my-1">
            100.0%
          </div>
          <div className="text-[11px] text-emerald-700 dark:text-emerald-400 mt-1 truncate border-t border-border pt-1.5">
            Reconciliation & Isolation
          </div>
        </div>

        {/* Card 5: Warning #FEF9C3 */}
        <div className="p-4 rounded-xl bg-card border border-amber-500/30 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
          <div className="flex items-center justify-between text-xs font-semibold text-amber-700 dark:text-amber-400 mb-1.5">
            ...
            <span className="font-mono text-[10px] text-amber-700 dark:text-amber-300 font-bold bg-amber-500/10 px-1 py-0.5 rounded border border-amber-500/20">#FEF9C3</span>
          </div>
          <div className="text-2xl font-black text-foreground tracking-tight my-1">
            {periods.filter(p => p.status === 'open').length}
          </div>
          <div className="text-[11px] text-amber-700 dark:text-amber-400 mt-1 truncate border-t border-border pt-1.5">
            Open Period(s) Protected
          </div>
        </div>

        {/* Card 6: Danger #FEE2E2 */}
        <div className="p-4 rounded-xl bg-card border border-rose-500/30 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
          <div className="flex items-center justify-between text-xs font-semibold text-rose-700 dark:text-rose-400 mb-1.5">
            <span className="flex items-center gap-1">
              <AlertOctagon className="w-3.5 h-3.5 text-rose-600 dark:text-rose-400" />
              <span>Danger</span>
            </span>
            <span className="font-mono text-[10px] text-rose-700 dark:text-rose-300 font-bold bg-rose-500/10 px-1 py-0.5 rounded border border-rose-500/20">#FEE2E2</span>
          </div>
          <div className="text-2xl font-black text-foreground tracking-tight my-1">
            0
          </div>
          <div className="text-[11px] text-rose-700 dark:text-rose-400 mt-1 truncate border-t border-border pt-1.5">
