    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-slate-100 mt-1">General Journal Register</h1>
      ...
      {/* Immutability Banner */}
      <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 text-xs text-slate-300 flex items-center justify-between gap-3">
        ...
        >
          <div className="space-y-4">
            <div className="p-3.5 rounded-lg bg-slate-950/70 border border-slate-800 text-xs">
              <span className="text-slate-500 block text-[10px] uppercase font-bold">Memo / Business Justification</span>
              <p className="text-slate-200 mt-1 font-medium">{selectedEntry.memo}</p>
            </div>
                  ...
                  {selectedEntry.lines.map((line: any) => {
                    ...
                    return (
                      <tr key={line.id} className="hover:bg-slate-800/30">
                        <td className="px-4 py-2.5 font-mono text-slate-500">{line.lineNumber}</td>
                        <td className="px-4 py-2.5">
                          <span className="font-mono font-bold text-brand-400 mr-2">{acc?.code}</span>
                          <span className="text-slate-300">{acc?.name}</span>
                        </td>
                        <td className="px-4 py-2.5 text-slate-400">{line.description}</td>
      ...
      >
        <form className="space-y-4">
          ...
          <div className="p-3 bg-slate-950/70 border border-slate-800 rounded-lg space-y-3">
            <span className="text-xs font-bold text-slate-300 block">Double-Entry Lines (Debit / Credit)</span>
