// ============================================================================
// Enterprise High-Density Table Component (Adaptive Semantic Theming & High Contrast)
// ============================================================================
    ...
    <div className="w-full overflow-hidden rounded-xl border border-border bg-card shadow-sm">
      <div className="overflow-x-auto">
        <table className="w-full text-left text-xs border-collapse">
          <thead>
            <tr className="border-b border-border bg-muted/60 text-foreground font-bold uppercase tracking-wider">
              {columns.map((col) => (
                <th
                  key={col.key}
                  className={clsx(
                    'px-4 py-3 select-none text-foreground font-semibold',
