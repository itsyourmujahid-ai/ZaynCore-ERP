// ============================================================================
// Enterprise Select Component (Adaptive Semantic Theming & High Contrast)
// ============================================================================
  ...
  ({ label, options, helperText, error, className, disabled, id, ...props }, ref) => {
    ...
    return (
      <div className="w-full space-y-1.5">
        {label && (
          <label htmlFor={selectId} className="block text-xs font-semibold text-foreground tracking-wider">
            {label}
        ...
        <div className="relative">
          <select
            ...
            className={twMerge(
              clsx(
                'block w-full rounded-lg bg-input border border-border text-foreground text-sm transition-colors duration-150 appearance-none shadow-sm',
