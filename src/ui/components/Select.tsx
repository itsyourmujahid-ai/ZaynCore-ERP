      ...
      <div className="w-full space-y-1.5">
        ...
        <div className="relative">
          <select
            ...
            className={twMerge(
              clsx(
                'block w-full rounded-lg bg-white border text-slate-900 text-sm transition-colors duration-150 appearance-none shadow-sm',
                'focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-brand-500',
                'px-3.5 py-2 pr-8 disabled:opacity-50 disabled:bg-slate-100 disabled:cursor-not-allowed',
