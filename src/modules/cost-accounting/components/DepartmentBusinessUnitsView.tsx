    ...
    <div className="space-y-5">
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="space-y-1.5 pt-1">
                  ...
                  <div className="flex justify-between text-slate-400 pt-1.5 border-t border-slate-800/80">
                    ...
                    <span className="font-mono font-bold text-slate-200">${parseFloat(dept.totalCost).toFixed(2)}</span>
                  </div>
                </div>

                <div className="p-2 rounded bg-slate-950/40 text-[11px] flex justify-between items-center text-slate-400">
          ...
          {buSummaries.map((bu) => (
            ...
            >
              <div className="space-y-3 text-xs">
                ...
                {bu.description && (
                  <p className="text-[11px] text-slate-500 pt-1 border-t border-slate-800/60 line-clamp-2">
                    {bu.description}
                  </p>
                )}
              </div>
      ...
      >
        <form onSubmit={handleCreateDept} className="space-y-4 text-xs">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-slate-300 font-medium mb-1">Primary Branch</label>
              <select
                value={deptBranchId}
          ...
          <div>
            <label className="block text-slate-300 font-medium mb-1">Department Manager</label>
            <input
              type="text"
      ...
      >
        <form onSubmit={handleCreateBu} className="space-y-4 text-xs">
          ...
          <div>
            <label className="block text-slate-300 font-medium mb-1">Business Unit Code *</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block text-slate-300 font-medium mb-1">Business Unit Name *</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block text-slate-300 font-medium mb-1">Divisional Lead / Manager</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-slate-300 font-medium mb-1">Description & Strategic Purpose</label>
            <textarea
              rows={2}
