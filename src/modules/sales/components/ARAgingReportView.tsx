    ...
    <div className="space-y-4">
      ...
      <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="px-3 py-1.5 text-xs bg-slate-950/80 border border-slate-800 rounded-lg text-slate-200 font-mono focus:outline-none focus:border-brand-500"
          />
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
        ...
        <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-800">
          ...
          <span className="text-[10px] text-slate-500">Notice required</span>
        </div>
        ...
        <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-800">
          ...
          <span className="text-[10px] text-slate-500">High credit risk</span>
        </div>

        <div className="p-3.5 rounded-xl bg-slate-900 border border-brand-500/30 col-span-2 sm:col-span-1">
          ...
          <span className="text-[10px] text-slate-500">GL Account #1200</span>
        </div>
      </div>
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-800/60 text-slate-200">
              {filteredBuckets.map((b) => (
                <tr key={b.customerId} className="hover:bg-slate-800/40 transition-colors">
            ...
            <tfoot>
              <tr className="border-t-2 border-slate-700 bg-slate-900/90 font-bold text-slate-100">
