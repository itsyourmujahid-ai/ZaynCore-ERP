        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {drafts.map((draft) => (
              <div
                key={draft.id}
                className="p-4 rounded-xl bg-card/90 border border-amber-500/20 hover:border-amber-500/40 transition-all flex flex-col justify-between space-y-3"
              >
                <div>
                    ...
                    <tr key={comp.id} className="hover:bg-muted/40 transition-colors">
                      <td className="px-5 py-4 max-w-xs">
                        <div className="flex items-center gap-3 min-w-0">
                          <div className="w-8 h-8 rounded-lg bg-muted flex items-center justify-center text-foreground/90 font-bold shrink-0">
                            {comp.code.slice(0, 2)}
                          </div>
                      ...
                      <td className="px-5 py-4 font-mono font-medium text-foreground/90">
                        {comp.baseCurrency}
                      </td>

                      <td className="px-5 py-4">
                        <span className="px-2 py-0.5 rounded bg-muted text-foreground/90 text-xs font-medium">
