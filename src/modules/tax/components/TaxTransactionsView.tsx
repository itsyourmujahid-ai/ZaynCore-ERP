      ...
      <div className="p-4 rounded-xl bg-card border border-border flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2 flex-1 min-w-[240px]">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-1.5 bg-card border border-border rounded-lg text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-brand-500"
            />
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            className="bg-card border border-border rounded-lg px-2.5 py-1.5 text-xs text-foreground focus:outline-none focus:border-brand-500"
          >
              ...
              <tbody className="divide-y divide-border text-foreground/90">
                {filteredEntries.map((e) => (
                  <tr key={e.id} className="hover:bg-muted/30 transition-colors">
                    <td className="py-2.5 px-3 font-mono text-muted-foreground whitespace-nowrap">{e.transactionDate}</td>
                    <td className="py-2.5 px-3 font-mono font-bold text-brand-400 whitespace-nowrap">
                      {e.documentNumber}
                    </td>
                    <td className="py-2.5 px-3">
                      <span className="px-1.5 py-0.5 rounded bg-muted text-[10px] font-mono text-foreground/90 uppercase">
                        {e.sourceModule}
                      </span>
                    </td>
                    <td className="py-2.5 px-3 font-medium text-foreground font-mono">{e.taxCode}</td>
                    ...
                    <td className="py-2.5 px-3 text-right font-mono text-foreground/90">
                    ...
                    <td className="py-2.5 px-3 text-center">
                      {e.journalEntryId ? (
                        ...
                        <span className="text-muted-foreground font-mono text-[10px]">Unposted</span>
                      )}
                    </td>
                  </tr>
                ))}
